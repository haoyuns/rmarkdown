...
![](https://github.com/haoyuns/Fall-2019/blob/master/images/rgb.jpg)
...
![](https://github.com/haoyuns/Fall-2019/blob/master/images/cmyk.png)
...
![](https://github.com/haoyuns/Fall-2019/blob/master/images/c-mono.jpeg)
---
...
![](https://github.com/haoyuns/Fall-2019/blob/master/images/c-complementary.jpeg)
---
...
![](https://github.com/haoyuns/Fall-2019/blob/master/images/c-split.jpeg)
...
![离散](https://github.com/haoyuns/Fall-2019/blob/master/images/d-diverging.png)

--

- **序列型**色系 Sequential  
一般是同一色调（Hue）的由浅及深或由深至浅；数值较小用浅色，较大用深色，适合单一主题、比重比较平均的数  
![序列](https://github.com/haoyuns/Fall-2019/blob/master/images/d-sequential.png)

--

- **分类型**色系 Qualitative/Categorical  
分类型的每种颜色都“各不相关”，采用不同色调；适合用来区分不同种类下的数据，如区分土地用途  
![分类](https://github.com/haoyuns/Fall-2019/blob/master/images/d-qualitative.png)
